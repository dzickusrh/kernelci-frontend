...
define([
    ...
    'utils/date'
], function(format, html, urls, testBtns, commonBtns, /*common,*/ date) {
    'use strict';
    var gViews;
    var kciView;
    ...
    kciView.createLabSection = function(lab) {
        ...
        buttonNode = testBtns.createShowHideLabBtn(lab, 'hide');
        buttonNode.addEventListener('click', testBtns.showHideLab, true);
    ...
    kciView.createPanels = function(result, index) {
        ...
        spinner.className = 'fa fa-circle-o-notch fa-spin fa-fw pull-right';
        statusParent.appendChild(spinner);
